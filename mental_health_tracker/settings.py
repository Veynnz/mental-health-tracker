...
SECRET_KEY = 'django-insecure-q9rxi#f*w!x+6#10gat*p2so!ydlwtw5sz0smm5te9eb1!sgao'
...
CSRF_TRUSTED_ORIGINS = ["http://localhost", "http://127.0.0.1", "http://dionysius-davis-mentalhealthtracker.pbp.cs.ui.ac.id", "https://dionysius-davis-mentalhealthtracker.pbp.cs.ui.ac.id", "dionysius-davis-mentalhealthtracker.pbp.cs.ui.ac.id"]
